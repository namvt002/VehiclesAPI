    ...
    public Car save(Car car) {
        if (car.getId() != null) {
            return repository.findById(car.getId())
                    .map(carToBeUpdated -> {
                        carToBeUpdated.setDetails(car.getDetails()); //set value new details
                        carToBeUpdated.setLocation(car.getLocation()); //set value new location
                        carToBeUpdated.setCondition(car.getCondition()); //set value new condition
